...
<article class="u-gallery-inner u-gallery-inner-1 tour-card">
    ...
    <div style="background-image: url('<?=$model->getMainImage()?>')" class="u-effect-fade u-gallery-item tour-card__img">
        ...
        <div class="tour-card__content">
            <p class="tour-card__country-city">
                <a href="<?=Url::to(['hotel/view', 'id' => $model->id])?>" class="tour-card__link"><?=$model->toCountry->Name?>, <?=$model->area->Name?></a>
            </p>
            <h4 class="tour-card__hotel">
                <a href="<?=Url::to(['hotel/view', 'id' => $model->id])?>" class="tour-card__link"><?=$model->hotel->Name?> <?=$model->hotel->category->ShortName?></a>
            </h4>
        </div>
        <div class="u-over-slide u-shading-n" style="background-image: url('<?=$model->getMainImage('b', 1)?>')"></div>
    ...
    <div class="card-info">
        <div class="tour-card__content">
            ...
            <h4 class="tour-card__hotel">
                <a href="<?=Url::to(['hotel/view', 'id' => $model->id])?>" class="tour-card__link"><?=$model->Name?> <?=$model->category->ShortName?></a>
            </h4>
            <div class="row">
                <div class="col-md-12">
                    <?php
