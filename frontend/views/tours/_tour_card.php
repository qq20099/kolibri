    ...
    <div style="background-image: url('<?=$model->hotel->getMainImage()?>')" class="u-effect-fade u-gallery-item tour-card__img">
        ...
        <div class="tour-card__content">
            <p class="tour-card__country-city">
                <a href="<?=Url::to(['tours/view', 'id' => $model->id])?>" class="tour-card__link"><?=$model->toCountry->Name?>, <?=$model->area->Name?></a>
            </p>
            <h4 class="tour-card__hotel">
                <a href="<?=Url::to(['tours/view', 'id' => $model->id])?>" class="tour-card__link"><?=$model->hotel->Name?></a>
            </h4>
        </div>
        <div class="u-over-slide u-shading u-over-slide-1">
            <h3 class="u-gallery-heading"><?=$model->hotel->Name?></h3>
