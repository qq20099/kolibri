...
<div data-v-bcb48e5a="" class="tours__nav">
   ...
   <pre style="display:none">
       ...
       <?print_r(\yii\helpers\ArrayHelper::map($dataProvider->getModels(), 'hotel.location0.country.id', 'hotel.location0.country.title'))?>
   </pre>
<?php                         //  die();
echo $form->field($searchModel, 'country_id')->widget(MultiSelect::className(), [
    'id' => 'chuse-country',
    'options' => [
        'multiple' => false,
        ...
        'data-pjax-options' => [
            '0' => [
                'url' => Url::to(['update-part', 'id' => '1', 'part' => 'sms']),
            ],
            '2' => [
                'url' => Url::to(['update-part', 'id' => '1', 'part' => 'subscribe']),
            ],
        ],
    ...
    //'data' => \yii\helpers\ArrayHelper::map(\common\helpers\DataHelper::getCountry(), 'id', 'title'),
