...
<div class="page-content">
    <div class="row">
        <div class="col-md-12">
            <p class="card-coutry-title">
                <a href="<?=Url::to(['/hotel', 'SearchTicket[country_id]' => $model->hotel->location0->country->id])?>"><?=$model->hotel->location0->country->title?></a>, <a href="<?=Url::to(['/hotel', 'SearchTicket[location_id]' => $model->hotel->location0->id])?>"><?=$model->hotel->location0->title?></a>
            </p>
            <h1><?=$model->hotel->title?></h1>
            <?php
    ...
    <div class="row">
        <div class="col-md-8 mb-3">
            <div class="row">
                <div class="col-md-12">
                    <img src="<?=$model->hotel->getMainImage()?>" class="card-img" alt="<?=$model->hotel->title?>" />
                </div>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="sti-block">
            <div class="fff mb-2">
                <div class="ff1 price-item"><?=$model->price?>&nbsp;€</div>
