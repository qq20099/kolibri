...
class Tours extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['FlightDate', 'AreaID', 'PlaceID', 'PackageNight', 'HotelID', 'MealID', 'RoomID', 'AccID', 'ToCountryID', 'SeatClassID', 'PackagePrice'], 'unique', 'targetAttribute' => ['FlightDate', 'AreaID', 'PlaceID', 'PackageNight', 'HotelID', 'MealID', 'RoomID', 'AccID', 'ToCountryID', 'SeatClassID', 'PackagePrice']],
